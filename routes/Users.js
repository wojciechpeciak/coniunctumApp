...
console.log('test path = ' + `${__dirname}/../client/build/userImg/${uniqueFilename}.jpg`, )
    imgFile.mv(`./client/build/userImg/${uniqueFilename}.jpg`, (err) => {
        console.log(err);
...
/*
    const upload = multer({storage}).single('messageImg');
